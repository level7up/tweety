...
class CpanelEmailTest extends BaseCpanel
{
    ...
    /** @test */
    function it_verifies_if_the_email_module_is_loading_correctly()
    {
        //given
    ...
    /** @test */
    function it_returns_an_emails_collection()
    {
        //given
    ...
    /** @test */
    function it_returns_an_emails_collection_with_an_email_when_filtering_for_the_given_string()
    {
        //given
        $email_module = $this->cpanel->email()->testHandler(
     ...
     */
    function it_sqwalks_when_trying_to_add_an_email_that_already_exists()
    {
        //given
     ...
     */
    function it_sqwalks_when_trying_to_add_an_email_and_the_server_returns_an_error()
    {
        //given
        $email_module = $this->cpanel->email();
        $new_email = new Email([
    ...
    /** @test */
    function it_returns_an_emails_collection_with_the_newly_stored_email()
    {
        //given
        $email_module = $this->cpanel->email();
        $new_email = new Email([
    ...
    /** @test */
    function it_searches_for_an_email_forward_for_the_given_email_object()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
    ...
    /** @test */
    function it_successfully_stores_a_forward_address_for_the_given_email()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
     ...
     */
    function it_sqwalks_when_storing_a_forward_address_for_the_given_email_returns_an_error()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
    ...
    /** @test */
    function it_removes_an_forward_address_from_the_given_email_address_and_target()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
     ...
     */
    function it_sqwalks_while_trying_to_remove_an_forward_address_from_the_given_email_address_and_target_and_it_returns_an_error()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
     ...
     */
    function it_sqwalks_when_trying_to_update_the_password_given_an_weak_password()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
     ...
     */
    function it_sqwalks_when_you_inform_an_invalid_object()
    {
        //given
        $email_module = $this->cpanel->email();
        $bad_email = new Email();
     ...
     */
    function it_sqwalks_when_you_try_to_change_the_quota_of_an_unauthorized_email()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
    ...
    /** @test */
    function it_successfully_changes_the_email_quota()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
     ...
     * @expectedExceptionMessage You do not own this email account.
     */
    function it_sqwalks_when_you_try_to_remove_someones_else_email()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
    ...
    /** @test */
    function it_destroys_the_given_email_address()
    {
        //given
        $email_module = $this->cpanel->email();
        $email_module->testHandler(
